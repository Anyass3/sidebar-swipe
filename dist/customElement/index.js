(function (global, factory) {
    ...
    var params = (function buildStore(){
        let defaults = {};
    ...
    function create_fragment(ctx) {
    	...
    	return {
    		c() {
    			...
    			attr(nav, "class", nav_class_value = !!/*Class*/ ctx[3] ? /*Class*/ ctx[3] : "");
    			attr(div, "id", /*id*/ ctx[2]);
    		},
    		m(target, anchor) {
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	$$self.$$set = $$new_props => {
    		...
    		if ("sideOpacity" in $$new_props) $$invalidate(4, sideOpacity = $$new_props.sideOpacity);
    		if ("maxScreenWidth" in $$new_props) $$invalidate(5, maxScreenWidth = $$new_props.maxScreenWidth);
    		if ("transitionDuration" in $$new_props) $$invalidate(6, transitionDuration = $$new_props.transitionDuration);
    		if ("transitionTimingFunc" in $$new_props) $$invalidate(7, transitionTimingFunc = $$new_props.transitionTimingFunc);
    	};

    	$$self.$$.update = () => {
    		if ($$self.$$.dirty & /*maxScreenWidth, transitionDuration, sideOpacity, transitionTimingFunc*/ 240) {
    			 params.set({
    				maxScreenWidth,
    				transitionDuration,
    				sideOpacity,
    ...
    class SideBarSwipe extends SvelteElement {
    	constructor(options) {
    		super();
    ...
    customElements.define("sidebar-swipe", SideBarSwipe);

    class SideBarSwipe$1 {
        constructor(
          query,
          {
            sideOpacity = 0.2,
    ...
    const swipe = (get_store_value(writable(()=>{
        let args=get_store_value(params);
        return new SideBarSwipe$1('#svelte-sidebar-swipe',args)
    })));

    exports.SideBarSwipe = SideBarSwipe;
    exports.sidebarswipe = swipe;
